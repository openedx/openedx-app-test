...
class AndroidRegister(AndroidBasePage):
    ...
    def __init__(self):
        super().__init__()
        self._register_text_sign_up_title = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("txt_sign_up_title")')
        self._register_txt_description = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("txt_sign_up_description")')
        self._register_txt_name_label = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("txt_name_label")')
        self._name_text_field = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("tf_name")')
        self._name_text_field_description = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("txt_name_description")')
        self._username_text_field_label = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("txt_username_label")')
        self._username_text_field = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("tf_username")')
        self._username_text_field_description = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("txt_username_description")')
        self._register_txt_email_label = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("txt_email_label")')
        self._register_tf_email = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("tf_email")')
        self._register_txt_email_description = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("txt_email_description")')
        self._register_txt_password_label = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("txt_password_label")')
        self._register_tf_password = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("tf_password")')
        self._register_txt_password_description = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("txt_password_description")')
        self._register_txt_country_label = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("txt_country_label")')
        self._register_tf_country = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("tf_country")')
        self._register_txt_country_description = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("txt_country_description")')
        self._register_txt_honor_code = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("txt_honor_code")')
        self._register_txt_optional_field = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("txt_optional_field")')
        self._register_btn_create_account = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("btn_create_account")')
        self._register_education_level = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("register_education_level")')
        self._register_education_level_placeholder = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("register_education_level_placeholder")')
        self._register_gender_label = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("txt_gender_label")')
        self._register_gender_label_placeholder = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("txt_gender_placeholder")')
        self._register_country_selection_dialogue = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("txt_selection_title")')
        self._register_country_sb_search = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("sb_search")')
        self._register_txt_US_title = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("txt_us_title")')
        self._google_auth_button = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().description("Continue with Google")')
        self._txt_facebook_auth = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().description("Continue with Facebook")')        
        self._txt_microsoft_auth = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().description("Continue with Microsoft")')
        self._honor_policy_text = Element(AppiumBy.ANDROID_UIAUTOMATOR, f'new UiSelector().text({values.REGISTER_HONOR_POLICY_TEXT})')        
