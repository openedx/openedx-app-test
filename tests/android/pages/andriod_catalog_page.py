...
class AndroidCatalogPage(AndroidBasePage):
    ...
    def __init__(self):
        ...
        self._search_field = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("pgn-searchfield-input-7")')
        self._search_button = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("search-landing-search-submit")')
        self._first_result = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("search-landing-product-result-0")')
        self._discovery_enroll_main_element = Element(AppiumBy.XPATH, '//android.view.View[@resource-id="enroll"]/android.view.View[1]/android.view.View')
        self._enroll_button = Element(AppiumBy.XPATH, 'new UiSelector().description("Enroll")')
        self._main_content = Element(AppiumBy.XPATH, 'new UiSelector().resourceId("main-content")')
        self._discovery_search_breakcrumbs = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().text("breadcrumb")')
        self._first_popular_course = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("subject-filter-0")')
        ...
        self._course_carosel = Element(AppiumBy.XPATH, '//android.view.View[@resource-id="main-content"]/android.view.View[4]')
    ...
    @property
    def course_carosel(self) -> Element:
        """"""
        return self._course_carosel
