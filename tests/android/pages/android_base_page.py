...
class AndroidBasePage:
    ...
    def __init__(self):
        ...
        self._text_toolbar_title = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("txt_toolbar_title")')
        ...
        self._android_native_permission_allow_button = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("com.android.permissioncontroller:id/permission_allow_button")')
        self._android_native_permission_revoke_button = Element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().resourceId("com.android.permissioncontroller:id/permission_deny_button")')
