...
class TestAndroidRegister:
    ...
    def test_ui_elements_smoke(self, set_capabilities, setup_logging):
        ...
        expect(android_register.get_txt_microsoft_auth).to_have(values.MICROSOFT_AUTH_TEXT, ElementAttribute.CONTENT_DESC)
    ...
    def test_show_optional_fields_smoke(self, set_capabilities, setup_logging):
        ...
        expect(android_register.get_register_education_level_placeholder).to_have(values.REGISTER_EDUCATION_LEVEL_PLACEHOLDER)
