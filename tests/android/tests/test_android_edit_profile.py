...
class TestAndroidEditProfile:
    ...
    def test_start_edit_profile_screen_smoke(
        self, login, set_capabilities, setup_logging
    ):
        """
        Scenarios:
    ...
    def test_validate_ui_elements(self, set_capabilities, setup_logging):
        ...
        expect(edit_profile_page.edit_profile_type_label).to_have(
            values.EDIT_PROFILE_TYPE_LABEL
        )
        expect(edit_profile_page.edit_profile_user_name).to_have(
            values.EDIT_PROFILE_USER_NAME
        )
        expect(edit_profile_page.edit_profile_limited_profile_message).to_have(
            values.EDIT_PROFILE_MESSAGE
        )
        expect(edit_profile_page.edit_profile_txt_label_location).to_have(
            values.EDIT_PROFILE_LOCATION_LABEL
        )
        expect(edit_profile_page.profile_tf_select_location).to_have(
            values.EDIT_PROFILE_LOCATION
        )
        expect(edit_profile_page.edit_profile_txt_label_spoken_language).to_have(
            values.EDIT_PROFILE_LANGUAGE_LABEL
        )
        expect(edit_profile_page.edit_profile_select_spoken_language).to_have(
            values.EDIT_PROFILE_LANGUAGE
        )
        expect(edit_profile_page.edit_profile_txt_label_about_me).to_have(
            values.EDIT_PROFILE_ABOUT_ME_LABEL
        )
        expect(edit_profile_page.edit_profile_txt_placeholder_about_me).to_have(
            values.EDIT_PROFILE_ABOUT_ME
        )
